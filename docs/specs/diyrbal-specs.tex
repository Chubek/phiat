...
Within a bundle definition, you can change how a bundle instance reacts to these operators. See \cref{}.


\begin{oplist}{Unary operators}
	\addop{+}{unaryPlus}
	\addop{-}{unaryMinus}
	\addop{++}{unaryPreIncrement}
	\addop{++}{unaryPostIncrement}
	\addop{\-\-}{unaryPreDecrement}
	\addop{\-\-}{unaryPostDecrement}
	\addop{~}{unaryNot}{Unary bitwise not}
	\addop{!}{unaryNegate}
	\addop{[]}{unaryBracketAccess}
	\addop{\{\}}{unaryCurlyAccess}
	\addop{()}{unaryCall}
	\addop{@}{unaryAddressOf}
	\addop{^}{unaryDereference}
	\addop{#}{binarySizeof}
\end{oplist}
...
\begin{oplist}{Binary operators}
	...
	\addop{\|}{binaryOr}
	\addop{\&}{binaryAnd}
	\addop{\&\&}{binaryConjunct}
	\addop{\|\|}{binaryDisjunct}
	\addop{..}{binaryConcat}
\end{oplist}

\notebox{Since assignement is an statement, \nm does not yield inplace operators, like C and similar languages do. However, the assignment statements, as we shall see, provide a variety of tools to simulate them!}
